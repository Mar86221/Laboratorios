...
public class FragmentMovieContainerBindingImpl extends FragmentMovieContainerBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.add_action, 8);
    }
    // views
    @NonNull
    ...
    public FragmentMovieContainerBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 9, sIncludes, sViewsWithIds));
    }
    private FragmentMovieContainerBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
